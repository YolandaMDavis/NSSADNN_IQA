...
if __name__ == '__main__':
    ...
    val_dataset = WildTrackDataset(root_dir + '/' + 'training' + image_reference_file_suffix, config, "validation")
    val_loader = torch.utils.data.DataLoader(val_dataset)
    valnum = val_dataset.row_count

    test_dataset = WildTrackDataset(root_dir + '/' + 'training' + image_reference_file_suffix, config, "testing")
